...
import antlr4.ILPMLgrammarPartielForListener;
import antlr4.ILPMLgrammarPartielForParser.ForContext;

import static antlr4.ILPMLgrammarPartielForParser.*;


public class ILPMLListener implements ILPMLgrammarPartielForListener{
    ...
    public void exitFor(ForContext ctx) {
        ctx.node = factory.newFor(
            (IASTassignment)factory.newAssignment(
