package com.paracamplus.ilp2.ilp2tme6.test.partie3;
...
import com.paracamplus.ilp2.ilp2tme6.interpreter.callanalysis.Interpreter;
...
public class InterpreterTest extends com.paracamplus.ilp2.interpreter.test.InterpreterTest{
     protected static String[] samplesDirName = { "SamplesTME6/partie3" };
    ...
    public void configureRunner(InterpreterRunner run) throws EvaluationException {
        ...
        Interpreter interpreter = new Interpreter(gve, oe,factory);        
