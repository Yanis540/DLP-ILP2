...
import antlr4.ILPMLgrammar2020_2Listener;

import static antlr4.ILPMLgrammar2020_2Parser.*;


public class ILPMLListener implements ILPMLgrammar2020_2Listener {
    ...
    public void exitSequenceN(SequenceNContext ctx) {
        ctx.node = factory.newSequenceN(toExpressions(ctx.exprs),ctx.index.node);
    }
