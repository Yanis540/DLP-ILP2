...
import antlr4.ILPMLgrammarPartiel2020Listener;
import antlr4.ILPMLgrammarPartiel2020Parser.SequenceNContext;

import static antlr4.ILPMLgrammarPartiel2020Parser.*;
public class ILPMLListener implements ILPMLgrammarPartiel2020Listener {
	...
	@Override
    public void enterSequenceN(SequenceNContext ctx) {
    }


    @Override
    public void exitSequenceN(SequenceNContext ctx) {
        ctx.node = factory.newSequenceN(
