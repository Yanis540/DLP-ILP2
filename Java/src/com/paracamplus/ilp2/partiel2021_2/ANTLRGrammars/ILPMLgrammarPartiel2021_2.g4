grammar ILPMLgrammarPartiel2021_2;
...
// expressions de la grammaire précédente
    ...
    | 'letrange' vars+=IDENT ':' lows+=expr '..' highs+=expr '=' vals+=expr ('and' vars+=IDENT ':' lows+=expr '..' highs+=expr'=' vals+=expr)*
      'in' body=expr # BindingRange
